...
export async function getFullAIAnalysisAction(profile: LinkedInProfile) {
  try {
    const prompt = `
      You are a world-class LinkedIn Profile Auditor and Career Coach. 
      Analyze the following profile data and provide a comprehensive audit in JSON format.
      ...
      CRITICAL: Return ONLY valid JSON. Be professional, metrics-oriented, and brutal in the roasts.
    `;
